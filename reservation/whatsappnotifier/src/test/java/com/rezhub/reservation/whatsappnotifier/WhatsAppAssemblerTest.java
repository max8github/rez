...
class WhatsAppAssemblerTest {
  ...
  @Test
  void jsonFromFile() throws Exception {
    String s = TUtility.assertAndReturnCanonicalPath("src/test/resources/whatsappmsg.json");
    byte[] bytes = TUtility.loadFileIntoBytes(new File(s));
    ObjectMapper objectMapper = new ObjectMapper();
    JsonNode jsonNode = objectMapper.readTree(bytes);
    System.out.println("content = " + jsonNode);
  }
