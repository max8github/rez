...
public class BookingAgent extends Agent {
    ...
    private static final String SYSTEM_MESSAGE = """
        ...
        - When bookCourt returns, the booking is NOT yet confirmed. Do not send any interim acknowledgement message. The booking outcome will be delivered asynchronously in a separate notification. Do NOT say the court is booked or wish them a good game.
