...
@ComponentScan({"com.rez.facility", "org.springframework.web.reactive.function.client", "com.mcalder.rez.stringparser", "com.mcalder.rez.calendarstub", "com.mcalder.rez.notifierstub"})
