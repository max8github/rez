...
## <a href="about:blank#_foundational_works"></a> Foundational Works

- [Principles and Patterns for Distributed Application Architecture](https://www.oreilly.com/library/view/principles-and-patterns/9781098181260/) — By Jonas Bonér (O’Reilly, 2025). The definitive guide to distributed systems architecture from Akka’s founder and CTO.
- [The Reactive Manifesto](https://www.reactivemanifesto.org/) — By Jonas Bonér, Dave Farley, Roland Kuhn, Martin Thompson. Four pillars: Responsive, Resilient, Elastic, Message Driven. The foundational philosophy behind Akka.
...
- [What is Agentic AI?](https://akka.io/blog/what-is-agentic-ai)
- [What is Agentic AI? (Comprehensive Guide)](https://akka.io/what-is-agentic-ai)
...
### <a href="about:blank#_architecture_design_patterns"></a> Architecture & Design Patterns

- [Cell-Based Architectures and Akka](https://akka.io/blog/cell-based-architectures-and-akka)
...
- [The Backbone of Agentic AI and Distributed Systems](https://akka.io/blog/the-backbone-of-agentic-ai-distributed-systems-and-oss-sustainability)

### <a href="about:blank#_protocols_standards"></a> Protocols & Standards

- [MCP](https://akka.io/blog/mcp-a2a-acp-what-does-it-all-mean)

### <a href="about:blank#_component_deep_dives"></a> Component Deep-Dives

- [Akka Agents: Create Agents](https://akka.io/blog/akka-agents-quickly-create-agents-mcp-grpc-api)
...
- [Demo: MCP Support in Akka](https://akka.io/blog/demo-mcp-support-in-akka)
...
## <a href="about:blank#_talks_podcasts"></a> Talks & Podcasts

- [CTO Asks CTO: Jonas Boner on Akka](https://akka.io/blog/cto-asks-cto-akka-ai-agents-distributed-systems)
...
## <a href="about:blank#_webinars"></a> Webinars
...
## <a href="about:blank#_training"></a> Training

- [Akkademy](https://akkademy.akka.io/) — Free training courses

## <a href="about:blank#_community"></a> Community
