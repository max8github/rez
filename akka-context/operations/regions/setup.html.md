...
The default primary selection mode for stateful components is the request-region mode, as explained in [Selecting primary for stateful components](about:blank#selecting-primary), and you might want to change that to pinned-region after the first deployment. That section also describes how you change the primary selection mode with a service descriptor.
...
### <a href="about:blank#_downing_of_region_for_disaster_recovery"></a> Downing of region for disaster recovery
...
<!-- <footer> -->
<!-- <nav> -->
[Regions](index.html) [Multi-region infrastructure](infrastructure.html)
<!-- </nav> -->
